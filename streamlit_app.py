...
def get_fruityvice_data(this_fruit_choice):
    ...
    fruityvice_normalized = pandas.json_normalize(fruityvice_response.json()) # Normalizes the JSON
...
try:
  ...
  if not fruit_choice:
    ...
    streamlit.dataframe(back_from_function) # Outputs data as a table
...
if streamlit.button('Add a fruit to the List'):
    ...
    streamlit.text(back_from_function) # Outputs data as a table
